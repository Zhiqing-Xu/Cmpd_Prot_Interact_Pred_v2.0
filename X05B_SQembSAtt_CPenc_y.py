...
from Z05B_SAtt import ATT_dataset, ATT_loader, SQembSAtt_CPenc_Model, SQembWtLr_CPenc_Model
...
if __name__ == "__main__":
    ...
    #--------------------------------------------------#
    encoding_file_list = ["X02A_" + dataset_nme + "_ECFP2_encodings_dict.p",     # 0
                          "X02A_" + dataset_nme + "_ECFP4_encodings_dict.p",     # 1
                          "X02A_" + dataset_nme + "_ECFP6_encodings_dict.p",     # 2
                          "X02A_" + dataset_nme + "_JTVAE_encodings_dict.p",     # 3
                          "X02A_" + dataset_nme + "_MorganFP_encodings_dict.p",  # 4
                          "X02B_" + dataset_nme + "_MgFP4_encodings_dict.p",]    # 5
    ...
    #====================================================================================================#
    # Get the model (Self-Attention)
    model = SQembSAtt_CPenc_Model(d_model= NN_input_dim,
                                  d_k = d_k,
                                  n_heads= n_heads,
                                  d_v = d_v,
                                  out_dim = 1,
