...
if __name__ == "__main__":
    ...
    dataset_nme   = dataset_nme_list[10]
    ...
    parser.add_argument("--datafile_name",        type=str,  default = datafile_name, help=\
        "Name of your datasets.")
    parser.add_argument("-b", "--batch_size",     type=int,  default = batch_size, help=\
        "Batch size.")
    parser.add_argument("-e", "--epoch_num",      type=int,  default = epoch_num, help=\
        "Epoch number.")
    parser.add_argument("--intermediate_savings", type=str,  default = inter_saving, help=\
        "Name of your datasets.")
    parser.add_argument("--final_saving",         type=str,  default = final_saving, help=\
        "Name of your datasets.")
    parser.add_argument("--datafile_FT",          type=str,  default = datafile_FT, help=\
        "Name of your datasets.")
    parser.add_argument("--datafile_Va",          type=str,  default = datafile_Va, help=\
        "Name of your datasets.")
