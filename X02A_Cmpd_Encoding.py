...
###################################################################################################################
###################################################################################################################
def X02A_Get_Cmpd_Encodings(data_folder, 
                       properties_file,
                       cmpd_encodings,
                       data_folder_2,
                       cmpd_JTVAE_file,
...
if __name__ == "__main__":
    ...
    #--------------------------------------------------#
    # In/Outputs
    i_o_put_file_1 = Path( Path("temp") / Path(Step_code + dataset_nme + "_all_ecfps" + str(ECFP_type) + ".p"))
    i_o_put_file_2 = Path( Path("temp") / Path(Step_code + dataset_nme + "_all_cmpds_ecfps" + str(ECFP_type) + "_dict.p"))
    #--------------------------------------------------#
    # Outputs
    ...
    #====================================================================================================#
    # Main
    X02A_Get_Cmpd_Encodings(**vars(args))
